...
package com.mycompany.myselion.logging;
...
public final class AppLogger {
    ...
    private static SimpleLoggerSettings getDefaultLoggerSettings(){
        ...
        settings.setUserLogFileName("MySelion.log");
        settings.setDeveloperLogFileName("MySelion-detailed.log");
        settings.setIdentifier("1.0.0");
